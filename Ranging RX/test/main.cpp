...
#define APP_NAME "SS TWR RESP v1.0" // Respond back 
...
#define RX_BUF_LEN 26 //Must be less than FRAME_LEN_MAX_EX
...
void loop() {
        ...
        if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
        {
            ...
            if (memcmp(rx_buffer, rx_poll_msg, ALL_MSG_COMMON_LEN) == 0)
            {
              ...
              uint32_t init_ts_tx, init_ts_rx, resp_tx_time;
              double dif_ini, dif_resp, finaldiff, tof;
              int ret;
              ...
              resp_msg_set_ts(&tx_resp_msg[10], resp_tx_ts);
              resp_msg_set_ts(&tx_resp_msg[14], resp_rx_ts);
